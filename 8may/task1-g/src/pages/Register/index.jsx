...
const Register = ({ state, dispatch }) => {
 ...
 async function userPosts (e) {
  ...
  <div className="relative flex flex-col rounded-xl bg-transparent bg-clip-border text-gray-700 shadow-none">
    ...
    <form onSubmit={userPosts} className="mt-8 mb-2 w-80 max-w-screen-lg sm:w-96">
      ...
      <div className="relative h-11 w-full min-w-[200px]">
        ...
        <div className="mb-2">
  <label htmlFor="messages" className="mb-2 block text-base font-medium text-[#07074D]">
    Gender
  </label>
